package com.jihan_18102091.praktikum9
...
import com.jihan_18102091.praktikum9.databinding.ActivitySettingPreferenceBinding
import com.jihan_18102091.praktikum9.preferences.SettingPreference
...
class SettingPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        if (p0?.id == R.id.btn_save) {
            ...
            val sifat = binding.edtSifat.text.toString().trim()
            ...
            if (sifat.isEmpty()) {
                binding.edtSifat.error = getString(R.string.field_required)
                return
            }
            if (alamat.isEmpty()) {
            ...
            saveSetting(name, email, age, phoneNo,sifat,alamat, isLoveMU)
    ...
    private fun showPreferenceInForm() {
        ...
        binding.edtSifat.setText(settingModel.sifat)
    ...
    private fun saveSetting(name: String, email: String, age: String, phoneNo: String, sifat: String, alamat: String, isLoveMU: Boolean) {
